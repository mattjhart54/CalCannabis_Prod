...
try{
	...
	logDebug("An error has occurred in ASUA:LICENSES/CULTIVATOR/*/APPLICATION: status withdrawn: " + err.message);
	logDebug(err.stack);
} 
...
try{
	...
	logDebug("An error has occurred in ASUA:LICENSES/CULTIVATOR/*/APPLICATION: status voided: " + err.message);
	logDebug(err.stack);
}
