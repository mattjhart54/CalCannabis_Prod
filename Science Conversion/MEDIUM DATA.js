/*------------------------------------------------------------------------------------------------------/
| Program: BATCH_MEDIUM_STATUS Update
...
eval(getScriptText("MEDIUM DATA"));
...
try{ 
	...
	//	logDebug("processing record " + WSTATUS[i]["License_Number"]);
		editAppSpecific("MEDIUM Review Status",WSTATUS[i]["MEDIUM_Source_Review"]);
	}
	...
	logDebug("ERROR: Science Conversion MEDIUM Status: " + err.message + " In " + batchJobName);
	logDebug("Stack: " + err.stack);
}}	
